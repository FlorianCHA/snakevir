...
rst_prolog = f"""
.. |tools_path| replace:: https://github.com/FlorianCHA/snakevir/
"""

# -- Project information -----------------------------------------------------
# General information about the project.
project = 'Snakevir'
github_doc_root = 'https://github.com/FlorianCHA/snakevir/tree/master'
issues_github_path = 'https://github.com/FlorianCHA/snakevir/issues'
latex_authors = '''
...
html_short_title = "Snakevir"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = '_images/snakevir_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_images/snakevir_logo.png'
